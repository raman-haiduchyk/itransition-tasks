...
export class ProfileComponent implements OnInit {
  ...
  public ngOnInit(): void {
    this.profileService.getProfile('profile/myprofile').subscribe(
      profileRes => {
        this.profile = profileRes;
        this.requestService.getFunficResponse('funfics/getmy').subscribe( funficRes =>
    ...
    dialogRef.afterClosed().subscribe(
      result => {
        if (result) {
          ...
          this.requestService.createFunficResponse('funfics/create', result).subscribe(
            res => {
  ...
  public onProfileChanges(): void {
    this.isChangeDisabled = true;
    this.profileService.setProfile('profile/changeprofile', this.profile).subscribe(
      res => {
        this.isChangeDisabled = false;
      },
      err => {
